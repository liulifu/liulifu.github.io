...
3.  **创建 Markdown 索引文件 (`posts/index.md`)**
    ...
    | :------------------------- | :--------- | :------------------------------- | :------------------------------------------- | :------ | :------ | :------------- |
    | 我的第一篇博客             | 2023-10-27 | 2023-10-27-my-first-post.md    | 这是我博客的第一篇文章，介绍博客的搭建过程。 | 示例用户 | v1.0    | CC BY-SA 4.0   |
...
5.  **检查线上博客:** 等待 GitHub Pages 更新（通常几秒到一分钟），然后访问你的 `your-username.github.io` 博客，确认新文章列表和内容是否按预期显示。
