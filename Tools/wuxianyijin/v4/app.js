...
function calculateInsurance() {
    ...
    const personalRateTotal = (pensionRatePersonal + medicalRatePersonal + unemploymentRatePersonal + injuryRatePersonal + maternityRatePersonal + housingRatePersonal) * 100;
    ...
    const results = `
        <table border="1">
            ...
            <tr>
                ...
                <td><strong>个人费率总计: ${personalRateTotal.toFixed(2)}%</strong></td>
            </tr>
        </table>
